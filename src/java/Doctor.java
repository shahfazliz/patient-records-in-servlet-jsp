...
public class Doctor extends HttpServlet {
    ...
    protected void doGet(
        ...
        request
            .getRequestDispatcher("/doctors.jsp")
    ...
    protected void doPost(
        ...
        try {
            ...
            if (request.getParameter("id") != null) {
                switch (request.getParameter("attribute")) {
                    case "name":
                        this.preparedStatement = this
                            .connection
                            .prepareStatement("UPDATE doctors SET name = ? WHERE id = ?");
                        break;
                    case "ic":
                        this.preparedStatement = this
                            .connection
                            .prepareStatement("UPDATE doctors SET ic = ? WHERE id = ?");
                        break;
                    case "email":
                        this.preparedStatement = this
                            .connection
                            .prepareStatement("UPDATE doctors SET email = ? WHERE id = ?");
                        break;
                    case "contact":
                        this.preparedStatement = this
                            .connection
                            .prepareStatement("UPDATE doctors SET contact = ? WHERE id = ?");
                        break;
                    case "active":
                        this.preparedStatement = this
                            .connection
                            .prepareStatement("UPDATE doctors SET active = ? WHERE id = ?");
                        break;
                }
                ...
                this.preparedStatement = this
                    .connection
                    .prepareStatement("INSERT INTO doctors (name, ic, email, contact) VALUES (?,?,?,?)");
